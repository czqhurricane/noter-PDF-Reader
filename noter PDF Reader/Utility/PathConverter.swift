...
enum PathConverter {
    ...
    static func parseVideoLink(_ url: String) -> (videoUrlString: String, start: String?, end: String?)? {
        ...
        NSLog("✅ PathConverter.swift -> PathConverter.parseVideoLink, 解析结果 - 视频链接: \(String(describing: videoUrlString)), start: \(String(describing: start)), end: \(String(describing: end))")
